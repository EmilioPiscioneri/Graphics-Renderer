...
UIntTween::UIntTween(unsigned int* valueToTween, unsigned int startValue, unsigned int targetValue, double tweenDuration, double tweenDelay, bool deleteOnEnd, Method method)
{
	useSetter = false;
...
UIntTween::UIntTween(SetterCallback setterCallback, unsigned int startValue, unsigned int targetValue, double tweenDuration, double tweenDelay, bool deleteOnEnd, Method method)
{
	useSetter = true;
...
void UIntTween::Update(double deltaTime)
{
	...
	if (_progressedSeconds > _delay) {
		...
		unsigned int newValue = _startValue + (unsigned int)((_targetValue - _startValue) * (timeSinceStart / _duration));
