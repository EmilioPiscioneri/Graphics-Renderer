...
UIntTween::UIntTween(unsigned int* valueToTween, unsigned int startValue, unsigned int targetValue, double tweenDuration, bool deleteOnEnd, Method method)
{
...
void UIntTween::Update(double deltaTime)
{
	...
	*_valueToTween = _startValue + (unsigned int)((_targetValue - _startValue) * (_progressedSeconds / _tweenDuration));
