...
IntTween::IntTween(int* valueToTween, int startValue, int targetValue, double tweenDuration, bool deleteOnEnd, Method method)
{
...
void IntTween::Update(double deltaTime)
{
	...
	*_valueToTween = _startValue + (int)((_targetValue - _startValue) * (_progressedSeconds / _tweenDuration));
